...
const footerLinks: Record<string, string[]> = {
  Product: ['Technologies', 'Your Stack', 'Roadmap'],
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-4">
              <span aria-label="GitHub" className="text-gray-500">
              ...
              <span aria-label="Twitter" className="text-gray-500">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </span>
              <span aria-label="LinkedIn" className="text-gray-500">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
          ...
          {Object.entries(footerLinks).map(([group, links]) => (
            <div key={group}>
              ...
              <ul className="space-y-2">
                {links.map((link) => (
                  <li key={link} className="text-gray-600 text-sm">
                    {link}
                  </li>
                ))}
              </ul>
